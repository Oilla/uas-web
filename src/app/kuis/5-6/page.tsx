...
const MOCKAPI_URL = 'https://6858c221138a18086dfbc0ba.mockapi.io/questions?classId=5-6';
...
return (
    <Box sx={{ backgroundColor: '#FEFFD5', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
        ...
        <Card sx={{ backgroundColor: '#1D5A4B', color: 'white', borderRadius: '20px', padding: '40px 30px', width: '100%', maxWidth: '800px' }}>
            <CardContent>
            <Box sx={{ border: '2px solid white', borderRadius: '16px', padding: '16px 24px', mb: 3 }}>
                <Typography variant="h5" component="p" sx={{ fontWeight: 'medium' }}>
                {currentQuestion.question}
                </Typography>
            </Box>

            {/* Opsi jawaban ke bawah */}
            <Box>
